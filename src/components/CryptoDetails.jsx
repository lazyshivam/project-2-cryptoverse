      ...
      <Col className="coin-details-container">
        ...
        >
          {time.map((date) => (
           ...
           {/* CAHRT implimentaion using chart.js*/}
        {/* line chart */}
        ...
        <Col className="stats-container">
          <Col className="coin-value-statistics">
            <Col className="coin-value-statistics-heading">
              ...
              <p>An overview showing the statistics of {cryptoDetails.name}, such as the base and <br /> quote currency, the rank, and trading volume.</p>
            </Col>
